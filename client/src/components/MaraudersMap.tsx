          ...
          >
            ...
            {activeRoomTab === 'great_hall' && (
              <>
                ...
                <circle cx="580" cy="510" r="16" fill="rgba(184, 134, 11, 0.3)" stroke="#7a5518" strokeWidth="2" />
                <text x="580" y="538" fill="#5c3f10" fontSize="12" fontWeight="bold" textAnchor="middle">🎩 Nón Phân Loại</text>
